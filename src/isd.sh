...
_ARGCOUNT_NO_OPTS=1
_OPTSTRING="p:hvf"
_CPP_TEMPLATE_PATH="/home/kkafara/workspace/scripts/templates/cpp_template.sh"
_LATEX_TEMPLATE_PATH="/home/kkafara/workspace/scripts/templates/latex_template.sh"
_MAKEFILE_TEMPLATE_PATH="/home/kkafara/workspace/scripts/templates/Makefile"
_PATH="$(pwd)"
# echo "$_PATH"
##################################################################################################
# RETURN VALS
